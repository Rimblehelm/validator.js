...
const validators = {
  ...
  'en-GB': str => /^([A-HJ-NPR-TV-Y]{1,2}\s*\d+|([A-HJ-NPR-TV-Y]{3}\s*\d{3}|\d{3}\s*[A-HJ-NPR-TV-Y]{3})|([A-HJ-NPR-TV-Y]{3}\s*[0-9]{3}\s*[A-HJ-NPR-TV-Y]|[A-HJ-NPR-TV-Y]\s*[0-9]{3}\s*[A-HJ-NPR-TV-Y]{3})|[A-Z]{2}\s*[0-9]{2}\s*[A-Z]{3})$/i.test(str),
